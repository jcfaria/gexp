...
```
The `gexp` package was elaborated inspired by the personal functions of Professor Faria, J. C., whose objective is to generate one or **p** random variables according to the type of experiment, whose effects of the treatments are indicated by the user.
